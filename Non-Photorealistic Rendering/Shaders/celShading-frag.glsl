...
vec3 PointLight(vec4 texDiffuse) 
{
	...
	// - Componente difusa: en función de si el ángulo formado por la dirección de la luz y la normal
	//   es menor o mayor, el tono será más o menos intenso
	float tone = floor(cosine * tones) / tones;
	diffuse *= tone;

	// - Componente especular: en función de si el ángulo formado por la dirección de reflexión de la luz y
	//   la dirección de visión es menor o mayor, además de la capacidad reflectiva del material, el tono
	...
	// - Generar una silueta aproximada (sombreado, de color negro), en función del ángulo formado por 
	//   la normal de la superficie y el vector de visión
